...
namespace SteelNova\Elementor\Atomic_Widgets\Atomic_Button;
...
class SteelNova_Atomic_Button extends Atomic_Widget_Base {
	use Has_Template;

	// protected function widget_info() {
    //     return [
    //         'name'       => 'steelnova-',
    //         'title'      => __( 'Case Navigation Menu', 'steelnova' ),
    //         'icon'       => 'eicon-nav-menu',
	...
	public function get_title() {
		return esc_html__( 'Button Test', 'elementor' );
	}
