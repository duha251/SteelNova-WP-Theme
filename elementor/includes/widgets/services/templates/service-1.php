...
$img_width = $display_args['img_width'] ?? null;
$img_height = $display_args['img_height'] ?? null;
$features = get_post_meta( $post->ID, 'service_features', true ) ?: [];

$service_icon = get_post_meta( $post->ID, 'service_icon', true ) ?: '';
?>
<div class="service">
    <div class="service__featured-image">
    ...
    <div class="service__content">
        ...
        <?php endif; ?>
        <a href="<?php echo esc_url( get_permalink( $post->ID ) ); ?>" class="button service__button">
