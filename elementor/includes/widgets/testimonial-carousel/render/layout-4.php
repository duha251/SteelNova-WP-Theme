...
$swiper_settings = steelnova_get_carousel_settings( $settings, [
    'breakpoints' => [
        ...
        'xl' => [
            ...
            'spaceBetween' => $settings['space_between_xl']['column'] ?: 45
        ],
        'xxl' => [
            'slidesPerView' => $settings['slides_per_view'] ?: 2,
            'gridRows' => $settings['swiper_grid_rows'] ?: 1,
            'spaceBetween' => $settings['space_between']['column'] ?: 64
        ],
    ]
]);
$img_width = $settings['img_size']['width'] ?: 767;
$img_height = $settings['img_size']['height'] ?: 1092;
    ...
    <div class="carousel__container swiper" data-swiper="<?php echo esc_attr( json_encode( $swiper_settings ) ); ?>">
        <div class="carousel__inner swiper-wrapper">
            <?php foreach( $settings['content_items'] as $i => $content ) : 
                ...
                $image_id = $settings['img_items'][$i]['img']['id'] ?? '';
            ?>
                <div class="carousel__item swiper-slide">
                    <div class="cs-testimonial">
                        
                        <div class="cs-testimonial__thumbnail">
                            <?php steelnova_print_image_by_size($image_id, $img_width, $img_height, ['class' => 'cs-testimonial__image']) ?> 
                        </div>
                        <div class="cs-testimonial__holder">
