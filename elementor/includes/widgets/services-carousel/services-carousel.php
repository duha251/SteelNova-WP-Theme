...
class Widget_Services_Carousel extends SteelNova_Widget_Base {
    /**
     * Get the widget information.
     */
    protected function widget_info() {
        return [
            'name'       => 'steelnova-services-carousel',
            'title'      => __( 'CS Services Carousel', 'steelnova' ),
            'icon'       => 'eicon-posts-carousel',
            'keywords'   => [ 'services', 'service', 'features', 'offerings' ],
            'script'     => ['steelnova-carousel'],
            'style'      => ['swiper', 'steelnova-swiper', 'steelnova-widget-service']
        ];
    }
        ...
        $this->visual_choice([
            ...
            'options' => [
                ...
                '2' => [
                    ...
                    'image' => content_url('/uploads/widget-layout/services-2.webp'),
                ],
                '3' => [
                    'title' => __('Layout 3', 'steelnova'),
                    'image' => content_url('/uploads/widget-layout/services-3.webp'),
                ],
                '4' => [
                    'title' => __('Layout 4', 'steelnova'),
                    'image' => content_url('/uploads/widget-layout/services-4.webp'),
                ],
            ],
            'default' => '1',
        ]);
